...
import { getDatabaseInfoById } from 'apiSdk/database-infos';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Database Info Detail View
          </Text>
          {hasAccess('database_info', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/database-infos/edit/${data?.id}`} passHref legacyBehavior>
              <Button

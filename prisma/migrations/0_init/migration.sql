...
-- AddForeignKey
ALTER TABLE "database_info" ADD CONSTRAINT "database_info_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
